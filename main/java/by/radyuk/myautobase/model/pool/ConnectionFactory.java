package by.radyuk.myautobase.model.pool;
...
class ConnectionFactory {
    ...
    static {
        URL fileURL = null;
        try {
            fileURL = ConnectionFactory.class.getClassLoader().getResource(FILE_PROPERTIES_NAME);
            if (fileURL == null) {
            ...
            logger.fatal("File can't be read. File = {}" + fileURL.getFile() + " ", driverName);
